...
export interface TextAreaPropTypes extends FormElementTypes<HTMLTextAreaElement> {
    wrapperClasses?: string;
    value?: string | number;
    maxlength?: number;
    autocomplete?: 'off' | 'on';
...
export interface RadioButtonsPropTypes extends FormElementTypes<HTMLInputElement> {
