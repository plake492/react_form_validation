    ...
    <div className="row" style={{ padding: '4rem' }}>
      ...
      >
        ...
        <Input
          ...
          value={user.address}
          isRequired
          onChange={(v) => setUser((prev) => ({ ...prev, ['address']: v }))}
        ...
        <Input
          ...
          onChange={(v) => setUser((prev) => ({ ...prev, ['addressTwo']: v }))}
          col={6}
        />
        <Input
          label="Postal Code"
        ...
        <Select
          ...
          id="gender"
          value={user.gender}
          onChange={(v) => setUser((prev) => ({ ...prev, ['gender']: v }))}
        ...
        <RadioButtons
          ...
          onChange={(v) => setUser((prev) => ({ ...prev, ['food']: v }))}
        />
        <Checkbox
          label={
          ...
          value={user.tos}
          onChange={() =>
            setUser((prev) => ({ ...prev, ['tos']: !prev['tos'] }))
          }
        />
      </Form>
    </div>
